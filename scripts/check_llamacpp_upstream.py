...
def check_snapshot(root: Path) -> dict[str, str]:
    ...
    expected = {
        ...
        "image_tag_cpu": "ghcr.io/ggml-org/llama.cpp:server-b10920",
        "image_tag_vulkan": "ghcr.io/ggml-org/llama.cpp:server-vulkan-b10920",
        "image_tag_cuda": "ghcr.io/ggml-org/llama.cpp:server-cuda-b10920",
    }
